...
public class StoreDTO {
	...
	public String getStoreOc() {
		return storeOc;
	}

	public void setStoreOc(String storeOc) {
	...
	public String toString() {
		return "StoreDTO [storeNum=" + storeNum + ", storeName=" + storeName + ", storeAddr=" + storeAddr + ", storeXy="
				...
				+ userNum + ", storeRegiday=" + storeRegiday + ", storeRegidayString=" + storeRegidayString
				+ ", storeOc=" + storeOc + "]";
	}
